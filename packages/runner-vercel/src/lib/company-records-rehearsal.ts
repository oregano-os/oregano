...
import { SlackRecordSourceConnector, SLACK_RECORD_SOURCE_CONNECTOR_ID, SLACK_RECORD_SOURCE_CONNECTOR_VERSION, SLACK_RECORD_SOURCE_CONNECTOR_VERSIONS } from "../../../connectors/slack/records-source.ts";
import {
...
function selectedSlackQualificationBinding(configuration: CompanyRecordsRehearsalConfiguration, sourceId: string) {
  ...
  if (binding.connector !== SLACK_RECORD_SOURCE_CONNECTOR_ID || !SLACK_RECORD_SOURCE_CONNECTOR_VERSIONS.some(version => version === binding.connector_version)) {
