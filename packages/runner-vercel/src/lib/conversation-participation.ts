...
export function slackConversationMessage(thread: Pick<Thread, "id" | "isDM">,
  message: Pick<Message, "id" | "text" | "author" | "metadata"> & Partial<Pick<Message, "isMention">> & { attachmentRefs?: readonly AttachmentReference[] },
  ...
  return {
    ...
    ...(message.attachmentRefs?.length ? { attachments: message.attachmentRefs } : {}),
