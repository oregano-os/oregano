  ...
  const store: BuilderTestStore = {
    ...
    async create(session) {
      ...
      if (!existing || sha256({ ...existing, revision: 0, stage: "prepared", artifactHash: undefined, testConversation: undefined, testUrl: undefined,
        result: undefined, conversation: undefined, testConversations: undefined, activeTestConversation: undefined, idleDays: undefined, discardedBy: undefined, feedback: undefined, acceptance: undefined, failureDigest: undefined }) !== sha256(session)) throw new Error("Test identity conflicts with a changed candidate or scope.");
      return existing;
    },
