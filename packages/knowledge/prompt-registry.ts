...
export const CORE_KNOWLEDGE_PROMPTS: readonly KnowledgePromptDefinition[] = [
  ...
  prompt({
    promptId: "knowledge.claim-extraction", version: "4", task: "claim-extraction", profile: "reasoning",
    inputSchemaId: "knowledge.claim-extraction.input@1", outputSchemaId: "knowledge.claim-extraction.output@3", fixtureSetId: "knowledge.claim-extraction.fixtures@1",
