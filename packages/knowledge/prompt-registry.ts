...
export const CORE_KNOWLEDGE_PROMPTS: readonly KnowledgePromptDefinition[] = [
  ...
  prompt({
    promptId: "knowledge.working-synthesis", version: "3", task: "working-synthesis", profile: "deep",
    ...
    evidenceRule: "List only supplied Claim identities in supportingClaimIds, contestedClaimIds, and supersededClaimIds, never repeat an identity within or across those arrays, and never invent a Claim identity.",
  }),
  prompt({
