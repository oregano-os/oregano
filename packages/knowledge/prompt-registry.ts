...
export const CORE_KNOWLEDGE_PROMPTS: readonly KnowledgePromptDefinition[] = [
  ...
  prompt({
    promptId: "knowledge.claim-extraction", version: "2", task: "claim-extraction", profile: "reasoning",
