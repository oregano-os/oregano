...
try {
  ...
  process.stdout.write(`${JSON.stringify({ ok: conversationEntries >= 2 && assistantEntries >= 1 && exactResponseEntries >= 1, conversation_entries: conversationEntries, assistant_entries: assistantEntries, exact_response_entries: exactResponseEntries })}\n`);
  if (conversationEntries < 2 || assistantEntries < 1 || exactResponseEntries < 1) process.exitCode = 2;
} catch (error) {
