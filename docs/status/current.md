...
- Oregano Core source is versioned `0.5.11` as the prepared patch candidate
  ...
  historical Sprint replays. The latest published release is `v0.5.10`;
  `v0.5.11` becomes authority only after its exact
  immutable tag and protected release commit pass the release workflow.
  Existing consumers may remain on `v0.5.10` until they adopt the new exact Core
